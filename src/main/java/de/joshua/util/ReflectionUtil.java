...
//    public static <T> @Nullable T getField(@NotNull final Class<T> clazz, final @NotNull String fieldName, @Nullable final T object) {
//        try {
...
//
//    @SuppressWarnings("unchecked")
//    public static <T> @Nullable T getField(@NotNull final T object, @NotNull final String fieldName) {
